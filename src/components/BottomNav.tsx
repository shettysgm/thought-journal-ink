...
import { LayoutGrid, Wind, BookOpen, HelpCircle } from 'lucide-react';
...
export default function BottomNav() {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-around max-w-lg md:max-w-2xl mx-auto px-2 pt-2 pb-1">
        {navItems.map((item) => {
